...
if(end){
  ...
  ctx.fillText('Game Over - Score: '+score, SIZE / 2, 300);
  if(newDirection == 5){
    location.reload();
  }
}else{
...
for(var i = 0; i< snake.length; i++){
  ...
  if(i>0) snake0bj[coordToString(a)] = true;
}

if(snake0bj[coordToString(snakePart)]) end = true;

while (!food || snake0bj[coordToString(food)]){
